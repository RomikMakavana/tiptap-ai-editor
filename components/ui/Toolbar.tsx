...
const ToolbarButton = forwardRef<HTMLButtonElement, ToolbarButtonProps>(
  (
    { children, buttonSize = 'icon', variant = 'ghost', className, tooltip, tooltipShortcut, activeClassname, onClick, ...rest },
    ref,
  ) => {
    const buttonClass = `gap-1 min-w-[2rem] px-2 w-auto ${className || ''}`.trim()
